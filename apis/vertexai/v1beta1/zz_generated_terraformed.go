...
// GetTerraformResourceType returns Terraform resource type for this FeaturestoreEntitytypeFeature
func (mg *FeaturestoreEntitytypeFeature) GetTerraformResourceType() string {
	return "google_vertex_ai_featurestore_entitytype_feature"
}

// GetConnectionDetailsMapping for this FeaturestoreEntitytypeFeature
func (tr *FeaturestoreEntitytypeFeature) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this FeaturestoreEntitytypeFeature
func (tr *FeaturestoreEntitytypeFeature) GetObservation() (map[string]any, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this FeaturestoreEntitytypeFeature
func (tr *FeaturestoreEntitytypeFeature) SetObservation(obs map[string]any) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this FeaturestoreEntitytypeFeature
func (tr *FeaturestoreEntitytypeFeature) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this FeaturestoreEntitytypeFeature
func (tr *FeaturestoreEntitytypeFeature) GetParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this FeaturestoreEntitytypeFeature
func (tr *FeaturestoreEntitytypeFeature) SetParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this FeaturestoreEntitytypeFeature using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FeaturestoreEntitytypeFeature) LateInitialize(attrs []byte) (bool, error) {
	params := &FeaturestoreEntitytypeFeatureParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *FeaturestoreEntitytypeFeature) GetTerraformSchemaVersion() int {
	return 0
}
